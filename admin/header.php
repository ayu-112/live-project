            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="manage-user.php">Manage User</a>
                  </li>
                  <!-- <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="manage-properties.php">Manage Properties</a>
                  </li>
                  <!-- <li class="nav-item">
                    <a class="nav-link" hrefProperties="pages/ui-features/typography.php">Typography</a>
                  </li> -->
                </ul>
              </div>
            </li>
              ...
              <div class="collapse" id="ui-basic2">
                <ul class="nav flex-column sub-menu">
                  ...
                  <!-- <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/dropdowns.php">Manage User</a>
                  </li> -->
                  <!-- <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/typography.php">Typography</a>
                  </li> -->
