                ...
                <div class="col-lg-6 col-md-6">
                  <div class="property-card">
                    <div class="property-image">
                      <img src="assets/img/real-estate/<?php echo $prop->property_image?>" alt="Modern Family Home" class="img-fluid">
                    ...
                    <div class="property-content">
                      <div class="property-price">$<?php echo $prop->property_price ?></div>
                      <h4 class="property-title"><?php echo $prop->property_name ?></h4>
                      <p class="property-location"><i class="bi bi-geo-alt"></i><?php echo $prop->property_location ?></p>
                      <div class="property-features">
                        <span><i class="bi bi-house"></i> <?php echo $prop->property_bed ?></span>
                        <span><i class="bi bi-water"></i> <?php echo $prop->property_bath ?></span>
                        <span><i class="bi bi-arrows-angle-expand"></i><?php echo $prop->property_sqft ?></span>
                      </div>
                      <div class="property-agent">
                        <img src="assets/img/real-estate/agent-1.webp" alt="Agent" class="agent-avatar">
                        <div class="agent-info">
                          <strong><?php echo $prop->property_agent_name ?></strong>
                          <div class="agent-contact">
                            <small><i class="bi bi-telephone"></i><?php echo $prop->property_agent_mobile?></small>
                          </div>
                        </div>
                      </div>
                      <a href="property-details?id=<?php  echo $prop->property_id?>" class="btn btn-primary w-100">View Details</a>
                    </div>
                  </div>
