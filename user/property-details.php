        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            ...
            <div class="property-overview sticky-top" data-aos="fade-up" data-aos-delay="200">
              <div class="price-tag"><?php echo $fetch->property_price ?></div>
              <div class="property-status">For Sale</div>

              <div class="property-address">
                <h4><?php echo $fetch->property_name ?></h4>
                <p><?php echo $fetch->property_location ?></p>
              </div>
              ...
              <div class="property-stats">
                <div class="stat-item">
                  ...
                  <div>
                    <span class="value"><?php echo $fetch->property_bed ?></span>
                ...
                <div class="stat-item">
                  ...
                  <div>
                    <span class="value"><?php echo $fetch->property_bath ?></span>
                ...
                <div class="stat-item">
                  ...
                  <form action="addcart?btn_cart" method="POST">
                  <div>
                   userid: <input type="text" name="userid" value="<?php echo  $_SESSION['userId']?>">
              property id: <input type="text" name="propid" value="<?php echo $fetch->property_id ?>">
              quentity :   <input min="1" max="5" name="qty" type="number" class="value"><?php echo $fetch->property_sqft ?></span>
              ...
              <div class="agent-info">
                ...
                <div class="agent-details">
                  <h4><?php echo $fetch->property_agent_name ?></h4>
                  <p class="agent-title">Licensed Real Estate Agent</p>
                  <p class="agent-phone"><i class="bi bi-telephone"></i><?php echo $fetch->property_agent_mobile ?></p>
                  <p class="agent-email"><i class="bi bi-envelope"></i>sarah@example.com</p>
                </div>

                <div>
                  <input  type="submit" name="buy" class= "btn btn-primary">buy</input>
                </div>
               </form>
              </div><!-- End Agent Info -->
